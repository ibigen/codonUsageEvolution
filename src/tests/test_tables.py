...
class Test(unittest.TestCase):
	...
	def test_read_fasta(self):
		...
		self.assertTrue((0.8295403880420882 == dataframe_RSCU_CAI[Constants.GENE_CAI]['lcl|NC_000913.3_cds_NP_414542.1_1']))
		self.assertEqual(0.8845878695503083, dataframe_RSCU_CAI[Constants.GENOME_CAI]['lcl|NC_000913.3_cds_NP_414542.1_1'])
