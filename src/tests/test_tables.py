...
class Test(unittest.TestCase):
    ...
    def test_tables(self):
        ecoli_fasta = os.path.join(self.baseDirectory, "files/references/ecoli.fasta")
        expected_result_RSCU_CAI = os.path.join(self.baseDirectory, "files/tables/table_RSCU_CAI_ecoli.csv")
        ...
        expected_result_counts = os.path.join(self.baseDirectory, "files/tables/table_counts_ecoli.csv")
